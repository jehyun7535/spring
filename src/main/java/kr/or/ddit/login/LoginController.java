...
public class LoginController {
	...
	//4
	@RequestMapping(path = "view", method = {RequestMethod.GET}, params = {})
	public String view() {
...
//	@RequestMapping("process")
	...
	public String process(UserVo userVo, HttpServletRequest request, HttpSession session,
		...
		if(dbUser != null && userVo.getPass().equals(dbUser.getPass())) {
			...
			//내부적으로 session 을 사용하여 속성을 저장
			//리다이렉트 처리가 완료 되면 스프링 프레임워크에서 자동으로 session 에서 제고
